...
import { PagePerso } from './pages/PagePerso.tsx';
...
const ONGLETS: Onglet[] = ['guide', 'perso', 'objet', 'prix', 'comparateur', 'explorateur'];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-encre">
      ...
      {onglet !== 'guide' && onglet !== 'perso' && <BarreBilan sim={sim} />}
      <main className="mx-auto max-w-6xl px-3 py-4">
        {onglet === 'guide' && <PageGuide aller={changerOnglet} />}
        {onglet === 'perso' && <PagePerso aller={changerOnglet} />}
