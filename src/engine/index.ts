...
export { optimiser, alternatives, statsItem, scoreStats, slotDe, bonusPanoplie, SLOTS, PRESETS, type Build, type Slot, type SlotDef, type Poids, type OptionsBuild } from './build.ts';
